...
_pa.segments = [{"name":"All visitors","id":451088,"regex":".*"}];
_pa.conversions = [{"name":"Application Page Visited","id":"54327","regex":"/applications/new/?([?#].*)*$"}];
_pa.conversionEvents = [{"name":"application_submitted","id":"54328"}];
_pa.segmentEvents = [];
_pa.thirdPartyTags = [];
_pa.thirdPartyTagEvents = [];
_pa.allVisitorsSegmentId = 451088;
_pa.clickThroughWindow = 30;
_pa.viewThroughWindow = 30;
_pa.rtbId = '689';
_pa.siteId = '508809960f043a0002000151';
